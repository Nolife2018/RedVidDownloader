    ...
    def __init__(self, url, quality=720, output="downloaded", destination=None):
        ...
        if quality not in qualityTypes:
            ...
            if 'v.redd.it' in self.postLink:
                ...
                self.GalleryPosts = requests.get("https://jackhammer.pythonanywhere.com/reddit/media/gallery",
...
class DownloadBySubreddit:
    ...
    def __init__(self, Subreddit, NumberOfPosts, flair=None, SortBy="hot", quality=720, output="downloaded",
                 destination=None):
        if SortBy == "hot" or SortBy == "new" or SortBy == "top":
            print("Fetching Posts...")
            try:
                self.PostLinks = requests.get("https://jackhammer.pythonanywhere.com//reddit/subreddit/all",
                                              params={'subreddit': Subreddit, 'number': NumberOfPosts, 'flair': flair,
                                                      'sort': SortBy})
...
class DownloadImagesBySubreddit:
    ...
    def __init__(self, Subreddit, NumberOfPosts, flair=None, SortBy="hot", quality=720, output="downloaded",
        ...
        if SortBy == "hot" or SortBy == "new" or SortBy == "top":
            print("Fetching Posts...")
            try:
                self.PostLinks = requests.get("https://jackhammer.pythonanywhere.com//reddit/subreddit/images",
                                              params={'subreddit': Subreddit, 'number': NumberOfPosts, 'flair': flair,
                                                      'sort': SortBy})
                Links = json.loads(self.PostLinks.content)
                self.ProcessedLinks = Links
...
class DownloadVideosBySubreddit:
    ...
    def __init__(self, Subreddit, NumberOfPosts, flair=None, SortBy="hot", quality=720, output="downloaded",
        ...
        if SortBy == "hot" or SortBy == "new" or SortBy == "top":
            print("Fetching Posts...")
            try:
                self.PostLinks = requests.get("https://jackhammer.pythonanywhere.com//reddit/subreddit/videos",
                                              params={'subreddit': Subreddit, 'number': NumberOfPosts, 'flair': flair,
                                                      'sort': SortBy})
                Links = json.loads(self.PostLinks.content)
                self.ProcessedLinks = Links
...
class DownloadGalleriesBySubreddit:
    ...
    def __init__(self, Subreddit, NumberOfPosts, flair=None, SortBy="hot", quality=720, output="downloaded",
        ...
        if SortBy == "hot" or SortBy == "new" or SortBy == "top":
            print("Fetching Posts...")
            try:
                self.PostLinks = requests.get("https://jackhammer.pythonanywhere.com//reddit/subreddit/galleries",
                                              params={'subreddit': Subreddit, 'number': NumberOfPosts, 'flair': flair,
                                                      'sort': SortBy})
                Links = json.loads(self.PostLinks.content)
                self.ProcessedLinks = Links
